...
Source0  : https://download.kde.org/stable/plasma/6.3.0/milou-6.3.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.0/milou-6.3.0.tar.xz.sig
...
%setup -q -n milou-6.3.0
cd %{_builddir}/milou-6.3.0
pushd ..
cp -a milou-6.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739297203
mkdir -p clr-build
pushd clr-build
