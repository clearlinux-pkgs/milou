...
Version  : 5.25.0
Release  : 66
URL      : https://download.kde.org/stable/plasma/5.25.0/milou-5.25.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.25.0/milou-5.25.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.25.0/milou-5.25.0.tar.xz.sig
...
%prep
%setup -q -n milou-5.25.0
cd %{_builddir}/milou-5.25.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655412746
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/milou-5.25.0/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/milou/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/milou-5.25.0/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/milou/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/milou-5.25.0/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/milou/2123756e0b1fc8243547235a33c0fcabfe3b9a51
cp %{_builddir}/milou-5.25.0/LICENSES/LGPL-2.1-only.txt %{buildroot}/usr/share/package-licenses/milou/81b58c89ceef8e9f8bd5d00a287edbd15f9d3567
cp %{_builddir}/milou-5.25.0/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/milou/19d98e1b6f8ef12849ea4012a052d3907f336c91
cp %{_builddir}/milou-5.25.0/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/milou/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/milou-5.25.0/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/milou/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/milou-5.25.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/milou/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/milou-5.25.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/milou/e458941548e0864907e654fa2e192844ae90fc32
pushd clr-build
%make_install
popd
