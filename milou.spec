...
Source0  : https://download.kde.org/stable/plasma/5.19.1/milou-5.19.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.19.1/milou-5.19.1.tar.xz.sig
...
%prep
%setup -q -n milou-5.19.1
cd %{_builddir}/milou-5.19.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1592334713
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/milou-5.19.1/COPYING %{buildroot}/usr/share/package-licenses/milou/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/milou-5.19.1/COPYING.LIB %{buildroot}/usr/share/package-licenses/milou/01a6b4bf79aca9b556822601186afab86e8c4fbf
pushd clr-build
%make_install
popd
%find_lang milou
