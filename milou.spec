...
Source0  : https://download.kde.org/stable/plasma/6.1.4/milou-6.1.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.4/milou-6.1.4.tar.xz.sig
...
%setup -q -n milou-6.1.4
cd %{_builddir}/milou-6.1.4
pushd ..
cp -a milou-6.1.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723137445
mkdir -p clr-build
pushd clr-build
