...
Source0  : https://download.kde.org/stable/plasma/6.2.5/milou-6.2.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.2.5/milou-6.2.5.tar.xz.sig
...
%setup -q -n milou-6.2.5
cd %{_builddir}/milou-6.2.5
pushd ..
cp -a milou-6.2.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736184459
mkdir -p clr-build
pushd clr-build
