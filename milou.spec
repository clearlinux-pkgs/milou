...
Version  : 6.3.2
Release  : 115
URL      : https://download.kde.org/stable/plasma/6.3.2/milou-6.3.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.3.2/milou-6.3.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.2/milou-6.3.2.tar.xz.sig
...
%setup -q -n milou-6.3.2
cd %{_builddir}/milou-6.3.2
pushd ..
cp -a milou-6.3.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740758021
mkdir -p clr-build
pushd clr-build
