...
Version  : 5.27.6
Release  : 86
URL      : https://download.kde.org/stable/plasma/5.27.6/milou-5.27.6.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.6/milou-5.27.6.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.6/milou-5.27.6.tar.xz.sig
...
%prep
%setup -q -n milou-5.27.6
cd %{_builddir}/milou-5.27.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1687285707
mkdir -p clr-build
pushd clr-build
