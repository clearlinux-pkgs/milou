...
Source0  : https://download.kde.org/stable/plasma/6.1.1/milou-6.1.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.1/milou-6.1.1.tar.xz.sig
...
%setup -q -n milou-6.1.1
cd %{_builddir}/milou-6.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719421798
mkdir -p clr-build
pushd clr-build
