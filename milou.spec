...
Version  : 6.1.2
Release  : 103
URL      : https://download.kde.org/stable/plasma/6.1.2/milou-6.1.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.2/milou-6.1.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.2/milou-6.1.2.tar.xz.sig
...
%setup -q -n milou-6.1.2
cd %{_builddir}/milou-6.1.2
pushd ..
cp -a milou-6.1.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720593822
mkdir -p clr-build
pushd clr-build
