...
Version  : 5.26.3
Release  : 75
URL      : https://download.kde.org/stable/plasma/5.26.3/milou-5.26.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.26.3/milou-5.26.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.26.3/milou-5.26.3.tar.xz.sig
...
%prep
%setup -q -n milou-5.26.3
cd %{_builddir}/milou-5.26.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667923126
mkdir -p clr-build
pushd clr-build
