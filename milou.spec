...
Version  : 6.1.3
Release  : 104
URL      : https://download.kde.org/stable/plasma/6.1.3/milou-6.1.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.3/milou-6.1.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.3/milou-6.1.3.tar.xz.sig
...
%setup -q -n milou-6.1.3
cd %{_builddir}/milou-6.1.3
pushd ..
cp -a milou-6.1.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721149612
mkdir -p clr-build
pushd clr-build
